/**
 *
 * @license Guriddo jqGrid JS - v5.0.0 - 2015-08-03 Copyright(c) 2008, Tony
...
!function (a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        version: "5.0.0", htmlDecode: function (a) {
            ...
            if (!this.grid) {
                ...
                var d = this, e = {
                    headers: [], cols: [], footers: [], dragStart: function (a, b, e) {
                        ...
                        if (this.resizing) {
                            var b, d, e = a.pageX - this.resizing.startX, f = this.headers[this.resizing.idx],
                        ...
                        if (a) {
                            ...
                            if (f) {
                                e.prevRowHeight = f;
                                var i, j, k, l = c.rowNum, m = e.scrollTop = e.bDiv.scrollTop,
                                    n = Math.round(g.position().top) - m, o = n + g.height(), p = f * l;
                ...
                var j, k = $.jgrid.getMethod("getStyleUI"), l = d.p.styleUI + ".common", m = k(l, "disabled", !0),
                    n = k(l, "highlight", !0), o = k(l, "hover", !0), p = k(l, "cornerall", !0),
                    q = k(l, "icon_base", !0), r = $.jgrid.msie, s = [], t = [], u = [];
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"], y = function (a, b) {
                    ...
                    var a, b, c, e, f, g, h, i, j, k, l, m = d.p, n = m.data, o = n.length, p = m.localReader,
                    ...
                    var f = new Date, g = "local" !== d.p.datatype && d.p.loadonce || "xmlstring" === d.p.datatype,
                        h = "_id_", i = d.p.xmlReader, j = "local" === d.p.datatype ? "local" : "xml";
                    if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                        ...
                        var m, n, o, p, q, r, s, t, u, v, w = $(d), x = 0, z = d.p.multiselect === !0 ? 1 : 0, A = 0,
                            B = d.p.rownumbers === !0 ? 1 : 0, I = [], J = {}, L = [],
                        ...
                        var P, Q = O.length, R = 0, S = [], T = parseInt(d.p.rowNum, 10),
                            U = d.p.scroll ? $.jgrid.randId() : 1;
                        if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                            e && (T *= e + 1);
                            var V, W = $.isFunction(d.p.afterInsertRow), X = !1,
                    ...
                    if (a) {
                        ...
                        var m, o, p, q, r, s, t, u, v, w, x, z, A = $(d), B = 0, I = [], J = d.p.multiselect ? 1 : 0,
                            L = d.p.subGrid === !0 ? 1 : 0, M = d.p.rownumbers === !0 ? 1 : 0, N = G(J + L + M),
                            O = F(h), P = {}, Q = [], R = d.p.altRows === !0 ? d.p.altclass : "",
                        ...
                        var Y, Z = $.isFunction(d.p.afterInsertRow), _ = [], ab = !1,
                    ...
                    if ($.isArray(d.p.data)) {
                        ...
                        if (d.p.ignoreCase && (q = q.ignoreCase()), d.p.search === !0) {
                            ...
                            if (r) "string" == typeof r && (r = $.jgrid.parse(r)), a(r); else try {
                        ...
                        var v = q.select(), w = parseInt(d.p.rowNum, 10), x = v.length, y = parseInt(d.p.page, 10),
                            z = Math.ceil(x / w), A = {};
                    ...
                    var c, e, f, g, h, i, j, n, p = "", q = d.p.pager ? $.jgrid.jqID(d.p.pager.substr(1)) : "",
                        r = q ? "_" + q : "", s = d.p.toppager ? "_" + d.p.toppager.substr(1) : "";
                    ...
                    var c, e, f, g, i, j, n,
                        p = "<td class='ui-pg-button " + m + "'><span class='ui-separator'></span></td>", r = "",
                        s = "<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>", t = "",
                        u = function (a, b) {
                            var c;
                    ...
                    var a, b, c, f, g = 0, h = $.jgrid.cell_width ? 0 : y(d.p.cellLayout, 0), i = 0,
                        j = y(d.p.scrollOffset, 0), k = !1, l = 0;
                ...
                var bb, cb, db, eb, fb, gb, hb, ib, jb = "<thead><tr class='ui-jqgrid-labels' role='row'>", kb = "",
                    lb = "", mb = "";
        ...
        getGridParam: function (a, b) {
            ...
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function () {
                ...
                var y, z = 0,
                    ...
                    B = {}, C = $.isFunction(w.p.afterInsertRow) ? !0 : !1;
            ...
            return a = $.extend({
                ...
                var b, c, d = "show" === a.method ? !0 : !1, e = $("#load_" + $.jgrid.jqID(this.p.id)),
                    f = $(window).scrollTop();
        ...
        editCell: function (a, b, c) {
            return this.each(function () {
                var d, e, f, g, h = this, i = $(this).jqGrid("getStyleUI", h.p.styleUI + ".common", "highlight", !0),
                ...
                if (h.grid && h.p.cellEdit === !0) {
                    ...
                    if (g = h.p.colModel[b], d = g.name, "subgrid" !== d && "cb" !== d && "rn" !== d) {
                        if (f = $("td:eq(" + b + ")", h.rows[a]), g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b)) parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && $(h.rows[h.p.iRow]).removeClass("selected-row " + j).find("td:eq(" + h.p.iCol + ")").removeClass("edit-cell " + i), f.addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j), e = f.html().replace(/\&#160\;/gi, ""), $(h).triggerHandler("jqGridSelectCell", [h.rows[a].id, d, e, a, b]), $.isFunction(h.p.onSelectCell) && h.p.onSelectCell.call(h, h.rows[a].id, d, e, a, b); else {
                            ...
                            try {
                                e = $.unformat.call(h, f, {rowId: h.rows[a].id, colModel: g}, b)
                            } catch (l) {
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.cellEdit === !0) {
                    if (c = d.p.savedRow.length >= 1 ? 0 : null, null !== c) {
                        var g, h, i = $("td:eq(" + b + ")", d.rows[a]), j = d.p.colModel[b], k = j.name,
                            l = $.jgrid.jqID(k);
                        switch (j.edittype) {
                            case"select":
                                if (j.editoptions.multiple) {
                                    var m = $("#" + a + "_" + l, d.rows[a]), n = [];
                            ...
                            case"custom":
                                try {
                                    ...
                                    "e1" === p ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.nodefined, f.bClose, {styleUI: d.p.styleUI}) : "e2" === p ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.novalue, f.bClose, {styleUI: d.p.styleUI}) : $.jgrid.info_dialog(e.errcap, p.message, f.bClose, {styleUI: d.p.styleUI})
                                }
                        }
                        if (h !== d.p.savedRow[c].v) {
                            ...
                            if (s[0] === !0) {
                                ...
                                if ($.isFunction(d.p.beforeSubmitCell) && (t = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), t || (t = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit) if (d.p.cellurl) {
                                    ...
                                    x = d.p.prmNames, v = x.id, w = x.oper, u[v] = $.jgrid.stripPref(d.p.idPrefix, d.rows[a].id), u[w] = x.editoper, u = $.extend(t, u), $(d).jqGrid("progressBar", {
                                        ...
                                        error: function (c, g, h) {
                                            $("#lui_" + $.jgrid.jqID(d.p.id)).hide(), d.grid.hDiv.loading = !1, $(d).triggerHandler("jqGridErrorCell", [c, g, h]), $.isFunction(d.p.errorCell) ? (d.p.errorCell.call(d, c, g, h), $(d).jqGrid("restoreCell", a, b)) : ($.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, {styleUI: d.p.styleUI}), $(d).jqGrid("restoreCell", a, b))
                                        }
                                    }, $.jgrid.ajaxOptions, d.p.ajaxCellOptions || {}))
                                } else try {
                                    $.jgrid.info_dialog(e.errcap, e.nourl, f.bClose, {styleUI: d.p.styleUI}), $(d).jqGrid("restoreCell", a, b)
                                } catch (p) {
                                }
                                ...
                                window.setTimeout(function () {
                                    $.jgrid.info_dialog(e.errcap, g + " " + s[1], f.bClose, {styleUI: d.p.styleUI})
        ...
        showModal: function (a) {
            ...
            if ($.fn.jqm && b.jqm === !0) $(a).attr("aria-hidden", "true").jqmHide(); else {
                if ("" !== b.gb) try {
            ...
            var h = this, i = "rtl" === $(c.gbox).attr("dir") ? !0 : !1,
                j = $.jgrid.styleUI[c.styleUI || "jQueryUI"].modal, k = $.jgrid.styleUI[c.styleUI || "jQueryUI"].common,
            ...
            if (i && p.left && !f && (s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8, p.left = parseInt(p.left, 10) + parseInt(s, 10)), p.left && (p.left += "px"), $(l).css($.extend({
                ...
                "aria-hidden": "true"
            }), void 0 === c.drag && (c.drag = !0), void 0 === c.resize && (c.resize = !0), c.drag) if ($(m).css("cursor", "move"), $.fn.jqDrag) $(l).jqDrag(m); else try {
                $(l).draggable({handle: $("#" + $.jgrid.jqID(m.id))})
            } catch (t) {
            }
            if (c.resize) if ($.fn.jqResize) $(l).append("<div class='jqResize " + j.resizable + " " + k.icon_base + " " + j.icon_resizable + "'></div>"), $("#" + $.jgrid.jqID(a.themodal)).jqResize(".jqResize", a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : !1); else try {
                $(l).resizable({handles: "se, sw", alsoResize: a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : !1})
            } catch (u) {
            }
            ...
            if (b = $.extend({
                ...
                jqm: !0,
                jqM: !0
            }, b || {}), void 0 === b.focusField && (b.focusField = 0), b.focusField = "number" == typeof b.focusField && b.focusField >= 0 ? parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? 0 : !1, $.fn.jqm && b.jqm === !0) b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow(); else if ("" !== b.gbox && ($(".jqgrid-overlay:first", b.gbox).show(), $(a).data("gbox", b.gbox)), $(a).show().attr("aria-hidden", "false"), b.focusField >= 0) try {
            ...
            switch (a) {
                case"textarea":
                    g = document.createElement("textarea"), d ? b.cols || $(g).css({width: "98%"}) : b.cols || (b.cols = 20), b.rows || (b.rows = 2), ("&nbsp;" === c || "&#160;" === c || 1 === c.length && 160 === c.charCodeAt(0)) && (c = ""), g.value = c, f(g, b), $(g).attr({
                        role: "textbox",
                        multiline: "true"
                    });
                    break;
                ...
                case"select":
                    ...
                    if (b.multiple === !0 ? (k = !0, g.multiple = "multiple", $(g).attr("aria-multiselectable", "true")) : k = !1, null != b.dataUrl) {
                        ...
                        h.p && h.p.idPrefix && (m = $.jgrid.stripPref(h.p.idPrefix, m)), $.ajax($.extend({
                            ...
                            success: function (a) {
                                var b, c = [], d = this.elem, e = this.vl, g = $.extend({}, this.options),
                                    i = g.multiple === !0, j = g.cacheUrlData === !0, k = "",
                        ...
                        if ("string" == typeof b.value) for (q = b.value.split(x), p = 0; p < q.length; p++) r = q[p].split(w), r.length > 2 && (r[1] = $.map(r, function (a, b) {
                            return b > 0 ? a : void 0
                        }).join(w)), s = document.createElement("option"), s.setAttribute("role", "option"), s.value = r[0], s.innerHTML = r[1], g.appendChild(s), k || $.trim(r[0]) !== $.trim(c) && $.trim(r[1]) !== $.trim(c) || (s.selected = "selected"), k && ($.inArray($.trim(r[1]), l) > -1 || $.inArray($.trim(r[0]), l) > -1) && (s.selected = "selected"); else if ("[object Array]" === Object.prototype.toString.call(b.value)) for (t = b.value, p = 0; p < t.length; p++) 2 === t[p].length && (u = t[p][0], v = t[p][1], s = document.createElement("option"), s.setAttribute("role", "option"), s.value = u, s.innerHTML = v, g.appendChild(s), k || $.trim(u) !== $.trim(c) && $.trim(v) !== $.trim(c) || (s.selected = "selected"), k && ($.inArray($.trim(v), l) > -1 || $.inArray($.trim(u), l) > -1) && (s.selected = "selected")); else if ("object" == typeof b.value) {
                            t = b.value;
                ...
                case"custom":
                    ...
                    try {
                        ...
                        if (!y) throw"e2";
                        y = $(y).addClass("customelement").attr({id: b.id, name: b.name}), $(g).empty().append(y)
                    } catch (o) {
                        var z = $.jgrid.getRegional(h, "errors"), A = $.jgrid.getRegional(h, "edit");
                        "e1" === o ? $.jgrid.info_dialog(z.errcap, "function 'custom_element' " + A.msg.nodefined, A.bClose, {styleUI: h.p.styleUI}) : "e2" === o ? $.jgrid.info_dialog(z.errcap, "function 'custom_element' " + A.msg.novalue, A.bClose, {styleUI: h.p.styleUI}) : $.jgrid.info_dialog(z.errcap, "string" == typeof o ? o : o.message, A.bClose, {styleUI: h.p.styleUI})
                    }
                    break;
                default:
                    var B;
                    B = "button" === a ? "button" : "textbox", g = document.createElement("input"), g.type = a, g.value = c, f(g, b), "button" !== a && (d ? b.size || $(g).css({width: "96%"}) : b.size || (b.size = 20)), $(g).attr("role", B)
            }
            return g
                ...
                if (this.p.initFilter = $.extend(!0, {}, this.p.filter), c) {
                    ...
                    this.onchange = function () {
                        ...
                        if (this.p.groupButton && (o = $("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + i.button + "'/>"), o.bind("click", function () {
                            ...
                            var p,
                                q = $("<input type='button' value='+' title='Add rule' class='add-rule ui-add " + i.button + "'/>");
                        ...
                        for (c = 0; c < m.p.columns.length; c++) {
                            var v = void 0 === m.p.columns[c].search ? !0 : m.p.columns[c].search,
                                w = m.p.columns[c].hidden === !0, x = m.p.columns[c].searchoptions.searchhidden === !0;
            ...
            return a = $.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                        ...
                        g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, h = function () {
                            var b, d, e, f = {}, g = 0, h = {};
                            ...
                            if (a.stringResult === !0 || "local" === c.p.datatype || a.searchOperators === !0) {
                                var j = '{"groupOp":"' + a.groupOp + '","rules":[', k = 0;
                                $.each(f, function (a, b) {
                                    k > 0 && (j += ","), j += '{"field":"' + a + '",', j += '"op":"' + h[a] + '",', b += "", j += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', k++
                                }), j += "]}", $.extend(c.p.postData, {filters: j}), $.each(["searchField", "searchString", "searchOper"], function (a, b) {
                                    c.p.postData.hasOwnProperty(b) && delete c.p.postData[b]
                                })
                            } else $.extend(c.p.postData, f);
                            var l;
                            c.p.searchurl && (l = c.p.url, $(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                            var m = "stop" === $(c).triggerHandler("jqGridToolbarBeforeSearch") ? !0 : !1;
                            !m && $.isFunction(a.beforeSearch) && (m = a.beforeSearch.call(c)), m || $(c).jqGrid("setGridParam", {search: i}).trigger("reloadGrid", [{page: 1}]), l && $(c).jqGrid("setGridParam", {url: l}), $(c).triggerHandler("jqGridToolbarAfterSearch"), $.isFunction(a.afterSearch) && a.afterSearch.call(c)
                        }, i = function (b) {
                            var d, e = {}, f = 0;
                            b = "boolean" != typeof b ? !0 : b, $.each(c.p.colModel, function () {
                                var a,
                                    b = $("#gs_" + c.p.idPrefix + $.jgrid.jqID(this.name), this.frozen === !0 && c.p.frozenColumns === !0 ? c.grid.fhDiv : c.grid.hDiv);
                            ...
                            var j;
                            c.p.searchurl && (j = c.p.url, $(c).jqGrid("setGridParam", {url: c.p.searchurl}));
                    ...
                    $.each(c.p.colModel, function (b) {
                        ...
                        if (this.hidden === !0 && $(s).css("display", "none"), this.search = this.search === !1 ? !1 : !0, void 0 === this.stype && (this.stype = "text"), f = $.extend({}, this.searchoptions || {}, {
                            ...
                            switch ($("td:eq(0)", u).attr("colindex", b).append(q), void 0 === f.clearSearch && (f.clearSearch = !0), f.clearSearch ? (m = a.resetTitle || "Clear Search Value", $("td:eq(2)", u).append("<a title='" + m + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + a.resetIcon + "</a>")) : $("td:eq(2)", u).hide(), this.surl && (f.dataUrl = this.surl), n = "", f.defaultValue && (n = $.isFunction(f.defaultValue) ? f.defaultValue.call(c) : f.defaultValue), o = $.jgrid.createEl.call(c, this.stype, f, n, !1, $.extend({}, $.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {})), $(o).css({width: "100%"}).addClass(e.srInput), $("td:eq(1)", u).append(o), $(t).append(u), this.stype) {
                                case"select":
            ...
            return a = $.extend(!0, {
                ...
                if (c.grid) {
                    var d, e = "fbox_" + c.p.id, f = !0, g = !0, h = {
                            ...
                            scrollelm: e
                        }, i = c.p.postData[a.sFilter], j = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                        k = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common;
                    if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]) b($("#fbox_" + $.jgrid.jqID(c.p.id))); else {
                        ...
                        if (a.showQuery && (t = "<a id='" + e + "_query' class='fm-button " + k.button + " fm-button-icon-left'><span class='" + k.icon_base + " " + j.icon_query + "'></span>Query</a>"), a.columns.length ? (q = a.columns, w = 0, o = q[0].index || q[0].name) : $.each(q, function (a, b) {
                            if (b.label || (b.label = c.p.colNames[a]), !v) {
                                var d = void 0 === b.search ? !0 : b.search, e = b.hidden === !0,
                        ...
                        v = !1, a.tmplNames && a.tmplNames.length && (v = !0, u = "<tr><td class='ui-search-label'>" + a.tmplLabel + "</td>", u += "<td><select class='ui-template " + j.srSelect + "'>", u += "<option value='default'>Default</option>", $.each(a.tmplNames, function (a, b) {
                        ...
                        }), a.multipleGroup === !0 && (a.multipleSearch = !0), $(c).triggerHandler("jqGridFilterInitialize", [$("#" + e)]), $.isFunction(a.onInitializeSearch) && a.onInitializeSearch.call(c, $("#" + e)), a.gbox = "#gbox_" + e, a.layer ? $.jgrid.createModal(h, l, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0], "#" + $.jgrid.jqID(a.layer), {position: "relative"}) : $.jgrid.createModal(h, l, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0]), (a.searchOnEnter || a.closeOnEscape) && $("#" + $.jgrid.jqID(h.themodal)).keydown(function (b) {
                            var c = $(b.target);
                            ...
                            return c.p.search = !0, $.extend(c.p.postData, i), g = $(c).triggerHandler("jqGridFilterSearch"), void 0 === g && (g = !0), g && $.isFunction(a.onSearch) && (g = a.onSearch.call(c, c.p.filters)), g !== !1 && $(c).trigger("reloadGrid", [{page: 1}]), a.closeAfterSearch && $.jgrid.hideModal("#" + $.jgrid.jqID(h.themodal), {
    ...
    if ($.jgrid.extend({
        editGridRow: function (a, b) {
            ...
            return b = $.extend(!0, {
                    ...
                    return $(x).find(".FormElement").each(function () {
                        ...
                        if (a.length) {
                            ...
                            $.each(p.p.colModel, function () {
                                if (this.name === c && this.editoptions && $.isFunction(this.editoptions.custom_value)) {
                                    try {
                                        ...
                                        "e1" === a ? $.jgrid.info_dialog(D.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.novalue, rp_ge[$(this)[0]].p.bClose, {styleUI: rp_ge[$(this)[0]].p.styleUI}) : $.jgrid.info_dialog(D.errcap, a.message, rp_ge[$(this)[0]].p.bClose, {styleUI: rp_ge[$(this)[0]].p.styleUI})
                                    }
                                    return !0
                                }
                            })
                            ...
                            switch ($(this).get(0).type) {
                                case"checkbox":
                                    if ($(this).is(":checked")) r[this.name] = $(this).val(); else {
                ...
                function d(a, b, c, d) {
                    var f, g, h, i, j, k, l, m = 0, n = [], o = !1,
                        q = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", r = "";
                    for (l = 1; d >= l; l++) r += q;
                    if ("_empty" !== a && (o = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function (l) {
                        if (f = this.name, g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
                            if (o === !1) i = ""; else if (f === b.p.ExpandColumn && b.p.treeGrid === !0) i = $("td[role='gridcell']:eq(" + l + ")", b.rows[o]).text(); else {
                                try {
                ...
                function g(a, b, c) {
                    ...
                    l && ($('td[role="gridcell"]', l).each(function (f) {
                        if (d = k[f].name, "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                            if (d === b.p.ExpandColumn && b.p.treeGrid === !0) e = $(this).text(); else try {
                            ...
                            switch (p.p.autoencode && (e = $.jgrid.htmlDecode(e)), (rp_ge[p.p.id].checkOnSubmit === !0 || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData[d] = e), d = $.jgrid.jqID(d), k[f].edittype) {
                                ...
                                case"custom":
                                    try {
                                        ...
                                        "e1" === l ? $.jgrid.info_dialog(D.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.nodefined, $.rp_ge[$(this)[0]].p.bClose, {styleUI: rp_ge[$(this)[0]].p.styleUI}) : $.jgrid.info_dialog(D.errcap, l.message, $.rp_ge[$(this)[0]].p.bClose, {styleUI: rp_ge[$(this)[0]].p.styleUI})
                                    }
                            }
                            j++
                        }
                ...
                function i() {
                    var a, c, d, e, i, j, k, l = [!0, "", ""], m = {}, n = p.p.prmNames,
                    ...
                    if (h(), l[0] && (m = $(p).triggerHandler("jqGridAddEditClickSubmit", [rp_ge[p.p.id], r, t]), void 0 === m && $.isFunction(rp_ge[p.p.id].onclickSubmit) && (m = rp_ge[p.p.id].onclickSubmit.call(p, rp_ge[p.p.id], r, t) || {}), l = $(p).triggerHandler("jqGridAddEditBeforeSubmit", [r, $(v), t]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[p.p.id].beforeSubmit) && (l = rp_ge[p.p.id].beforeSubmit.call(p, r, $(v), t))), l[0] && !rp_ge[p.p.id].processing) {
                        ...
                        var w = $.extend({
                            ...
                            complete: function (e, h) {
                                var j;
                                if ($("#sData", x + "_2").removeClass(f.active), r[c] = p.p.idPrefix + r[c], e.status >= 300 && 304 !== e.status ? (l[0] = !1, l[1] = $(p).triggerHandler("jqGridAddEditErrorTextFormat", [e, t]), l[1] = $.isFunction(rp_ge[p.p.id].errorTextFormat) ? rp_ge[p.p.id].errorTextFormat.call(p, e, t) : h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(p).triggerHandler("jqGridAddEditAfterSubmit", [e, r, t]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[p.p.id].afterSubmit) && (l = rp_ge[p.p.id].afterSubmit.call(p, e, r, t))), l[0] === !1) $(".FormError", v).html(l[1]), $(".FormError", v).show(); else if (p.p.autoencode && $.each(r, function (a, b) {
                ...
                function n() {
                    var a = $(p).jqGrid("getDataIDs"), b = $("#id_g", x).val(), c = $.inArray(b, a);
                    return [c, a]
                }
                ...
                if (p.grid && a) {
                    ...
                    var F,
                        G = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px",
                    ...
                    if (C ? (F = o(rp_ge[$(this)[0].p.id].template), q = x) : (F = $("<table id='" + w + "' class='EditTable ui-common-table'><tbody></tbody></table>"), q = x + "_2"), v = "#" + $.jgrid.jqID(v), $(I).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(I).append("<div class='tinfo topinfo'>" + rp_ge[p.p.id].topinfo + "</div>"), $(p.p.colModel).each(function () {
                        ...
                        l(), d(a, p, F, A);
                        var J = "rtl" === p.p.direction ? !0 : !1, K = J ? "nData" : "pData", L = J ? "pData" : "nData",
                        ...
                        $(p).triggerHandler("jqGridAddEditInitializeForm", [$(v), t]), $.isFunction(rp_ge[p.p.id].onInitializeForm) && rp_ge[p.p.id].onInitializeForm.call(p, $(v), t), "_empty" !== a && rp_ge[p.p.id].viewPagerButtons ? $("#pData,#nData", q).show() : $("#pData,#nData", q).hide(), $(p).triggerHandler("jqGridAddEditBeforeShowForm", [$(v), t]), $.isFunction(rp_ge[p.p.id].beforeShowForm) && rp_ge[p.p.id].beforeShowForm.call(p, $(v), t), $("#" + $.jgrid.jqID(y.themodal)).data("onClose", rp_ge[p.p.id].onClose), $.jgrid.viewModal("#" + $.jgrid.jqID(y.themodal), {
                            ...
                            onHide: function (a) {
                                var b = $("#editmod" + u)[0].style.height, c = $("#editmod" + u)[0].style.width;
            ...
            return b = $.extend(!0, {
                ...
                function i() {
                    var a = $(j).jqGrid("getDataIDs"), b = $("#id_g", "#" + m).val(), c = $.inArray(b, a);
                    return [c, a]
                }
                ...
                if (j.grid && a) {
                    var k = j.p.id, l = "ViewGrid_" + $.jgrid.jqID(k), m = "ViewTbl_" + $.jgrid.jqID(k),
                        n = "ViewGrid_" + k, o = "ViewTbl_" + k, p = {
                            ...
                            scrollelm: l
                        }, q = $.isFunction(rp_ge[j.p.id].beforeInitData) ? rp_ge[j.p.id].beforeInitData : !1, r = !0,
                        s = 1, t = 0;
                    ...
                    if ($(j.p.colModel).each(function () {
                        ...
                        d(a, j, x, s);
                        var y = "rtl" === j.p.direction ? !0 : !1, z = y ? "nData" : "pData", A = y ? "pData" : "nData",
            ...
            return b = $.extend(!0, {
                ...
                if (c.grid && a) {
                    var d, g, h, i, j = $.isFunction(rp_ge[c.p.id].beforeShowForm),
                        ...
                        l = $.isFunction(rp_ge[c.p.id].beforeInitData) ? rp_ge[c.p.id].beforeInitData : !1, m = c.p.id,
                        n = {}, o = !0, p = "DelTbl_" + $.jgrid.jqID(m), q = "DelTbl_" + m,
                        r = {themodal: "delmod" + m, modalhead: "delhd" + m, modalcontent: "delcnt" + m, scrollelm: p};
                            ...
                            if (n = {}, $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}), $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)), e[0] && !rp_ge[c.p.id].processing) {
                                ...
                                var k = $.extend({
                                    ...
                                    complete: function (a, g) {
                                        var h;
                                        if ($("#dData", "#" + p + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, e[1] = $.isFunction(rp_ge[c.p.id].errorTextFormat) ? rp_ge[c.p.id].errorTextFormat.call(c, a) : g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)), e[0] === !1) $("#DelError>td", "#" + p).html(e[1]), $("#DelError", "#" + p).show(); else {
                                            if (rp_ge[c.p.id].reloadAfterSubmit && "local" !== c.p.datatype) $(c).trigger("reloadGrid"); else {
                                                ...
                                                } else for (h = 0; h < j.length; h++) $(c).jqGrid("delRowData", c.p.idPrefix + j[h]);
                ...
                if (!this.p.navGrid) {
                    ...
                    if (o.grid && "string" == typeof a) {
                        ...
                        for (m.cloneToTop && o.p.toppager && (q = 2), p = 0; q > p; p++) {
                            var t, u, v,
                                w = $("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
            ...
            return this.each(function () {
                var i = this, j = i.p.styleUI, k = ($.jgrid.styleUI[j].navigator, $.jgrid.styleUI[j].filter),
                    l = $.jgrid.styleUI[j].common, m = "form_menu_" + $.jgrid.randId(),
                ...
                p(), $(".dropdownmenu").on("click", function () {
                    var a = $(this).offset(), b = a.left, c = parseInt(a.top), d = $(this).val();
                    $("#" + d).show().css({top: c - ($("#" + d).height() + 10) + "px", left: b + "px"})
                }), $("body").on("click", function (a) {
        ...
        groupingSetup: function () {
            ...
            return this.each(function () {
                ...
                var f, g, h = d.join("_"), i = c.minusicon, j = c.plusicon, k = $("#" + $.jgrid.jqID(a)),
                    l = k.length ? k[0].nextSibling : null,
                    m = $("#" + $.jgrid.jqID(a) + " span.tree-wrap-" + b.p.direction), n = function (a) {
                    ...
                    }, o = !1, p = !1, q = b.p.frozenColumns ? b.p.id + "_frozen" : !1,
                    r = q ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(q)) : !1,
                    s = r && r.length ? r[0].nextSibling : null;
                if (m.hasClass(i)) {
                    if (c.showSummaryOnHide) {
                        if (l) for (; l && (f = n(l.className), !(void 0 !== f && e >= f));) $(l).hide(), l = l.nextSibling, q && ($(s).hide(), s = s.nextSibling)
                    } else if (l) for (; l && (f = n(l.className), !(void 0 !== f && e >= f));) $(l).hide(), l = l.nextSibling, q && ($(s).hide(), s = s.nextSibling);
            ...
            return this.each(function () {
                ...
                function f(a, c, d, f) {
                    ...
                    for (h = f; b > h; h++) {
                        var n = "<td " + j.formatCol(h, 1, "") + ">&#160;</td>", o = "{0}";
                ...
                t.reverse(), r = j.p.multiselect ? ' colspan="2"' : "", $.each(k.groups, function (e, u) {
                    ...
                    var x = p - 1 === u.idx;
                    if (x) {
                        var y, z, A = k.groups[e + 1], B = 0, C = u.startRow,
            ...
            return a = $.extend({useColSpanStyle: !1, groupHeaders: []}, a || {}), this.each(function () {
                ...
                for ($(p).prepend(w), d = $("<tr>", {role: "row"}).addClass("ui-jqgrid-labels jqg-third-row-header"), b = 0; s > b; b++) if (f = t[b].el, g = $(f), c = r[b], h = {
                    height: "0px",
                    width: t[b].width + "px",
                    display: c.hidden ? "none" : ""
                }, $("<th>", {role: "gridcell"}).css(h).addClass("ui-first-th-" + p.p.direction).appendTo(x), f.style.width = "", i = A(c.name, a.groupHeaders), i >= 0) {
                ...
                } else 0 === q ? a.useColSpanStyle ? g.attr("rowspan", "10") : ($("<th>", {role: "columnheader"}).addClass(y.headerBox + " ui-th-column-header ui-th-" + p.p.direction).css({display: c.hidden ? "none" : ""}).insertBefore(g), d.append(f)) : (d.append(f), q--);
            ...
            return void 0 === a && (a = !0), this.each(function () {
                var b, c, d, e, f, g, h, i = this, j = i.grid, k = $("table.ui-jqgrid-htable thead", j.hDiv),
                    l = i.p.colModel;
                if (j) {
                    for ($(this).unbind(".setGroupHeaders"), b = $("<tr>", {role: "row"}).addClass("ui-jqgrid-labels"), e = j.headers, c = 0, d = e.length; d > c; c++) {
                    ...
                    $(k).children("tr.ui-jqgrid-labels").remove(), $(k).prepend(b), a === !0 && $(i).jqGrid("setGridParam", {groupHeader: null})
                }
            })
        }
        ...
        saveState: function (a, b) {
            ...
            if (c = $.extend({
                ...
                if (b) {
                    ...
                    if (d = jqGridUtils.parse(b), d && "object" === $.type(d)) {
                        ...
                        var m = $("#" + a).jqGrid(d);
                        m.append(f), m.jqGrid("setGridParam", l), d.storeNavOptions && m.jqGrid("navGrid", d.pager, d.navOptions, d.editOptions, d.addOptions, d.delOptions, d.searchOptions, d.viewOptions), d.inlineNav && g && (m.jqGrid("setGridParam", {inlineNav: !1}), m.jqGrid("inlineNav", d.pager, g)), d.filterToolbar && h && (m.jqGrid("setGridParam", {filterToolbar: !1}), m.jqGrid("filterToolbar", h)), m[0].updatepager(!0, !0), c.clearAfterLoad && (window[c.storageType].removeItem("jqGrid" + i.id), window[c.storageType].removeItem("jqGrid" + i.id + "_data"))
                    } else alert("can not convert to object")
                }
            }
        }, setRegional: function (a, b) {
            $.jgrid.saveState(a, {storageType: "sessionStorage"}), $.jgrid.loadState(a, null, {
                storageType: "sessionStorage",
                beforeSetGrid: function (a) {
                    return a.regional = b.regional, a.force_regional = !0, a
                }
            });
            var c = $("#" + a)[0], d = $(c).jqGrid("getGridParam", "colModel"), e = -1,
            ...
            var c = (0 === a.indexOf("#") ? "" : "#") + $.jgrid.jqID(a), d = function (a, b) {
                ...
                if (a && "string" == typeof a) {
                    var d = jqGridUtils.parse(a), e = d[b.jsonGrid.config], f = d[b.jsonGrid.data];
                    if (f) {
                        var g = e.datatype;
        ...
        jqGridExport: function (a) {
            a = $.extend({exptype: "xmlstring", root: "grid", ident: "	", addOptions: {}}, a || {});
            var b = null;
            return this.each(function () {
                if (this.grid) {
                    ...
                    switch (a.exptype) {
                        case"xmlstring":
                            b = "<" + a.root + ">" + jqGridUtils.jsonToXML(d, {xmlDecl: ""}) + "</" + a.root + ">";
                            break;
                        case"jsonstring":
        ...
        editRow: function (a, b, c, d, e, f, g, h, i) {
            var j = {}, k = $.makeArray(arguments).slice(1);
            return "object" === $.type(k[0]) ? j = k[0] : (void 0 !== b && (j.keys = b), $.isFunction(c) && (j.oneditfunc = c), $.isFunction(d) && (j.successfunc = d), void 0 !== e && (j.url = e), void 0 !== f && (j.extraparam = f), $.isFunction(g) && (j.aftersavefunc = g), $.isFunction(h) && (j.errorfunc = h), $.isFunction(i) && (j.afterrestorefunc = i)), j = $.extend(!0, {
                ...
                var b, c, d, e, f, g, h = this, i = 0, k = null, l = {},
                ...
                h.grid && (e = $(h).jqGrid("getInd", a, !0), e !== !1 && (g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0, void 0 === g && (g = !0), g && (d = $(e).attr("editable") || "0", "0" !== d || $(e).hasClass("not-editable-row") || (f = h.p.colModel, $('td[role="gridcell"]', e).each(function (d) {
                    ...
                    if (e) c = $("span:first", this).html(); else try {
                        c = $.unformat.call(h, this, {rowId: a, colModel: f[d]}, d)
                    } catch (g) {
            ...
            var v = $.jgrid.getRegional(this, "errors"), w = $.jgrid.getRegional(this, "edit"),
            ...
            if (void 0 === x && (x = !0), x) {
                if (l = $(o).attr("editable"), i.url = i.url || j.p.editurl, "1" === l) {
                    ...
                    if ($('td[role="gridcell"]', o).each(function (a) {
                            ...
                            switch (y.edittype) {
                                ...
                                case"custom":
                                    try {
                                        ...
                                        "e1" === e ? $.jgrid.info_dialog(v.errcap, "function 'custom_value' " + w.msg.nodefined, w.bClose, {styleUI: j.p.styleUI}) : $.jgrid.info_dialog(v.errcap, e.message, w.bClose, {styleUI: j.p.styleUI})
                                    }
                            }
                        ...
                        try {
                            var z = $(j).jqGrid("getGridRowById", a), A = $.jgrid.findPos(z);
                    ...
                    if (C = j.p.keyName === !1 ? D.id : j.p.keyName, q) {
                        if (q[D.oper] = D.editoper, void 0 === q[C] || "" === q[C]) q[C] = a; else if (o.id !== j.p.idPrefix + q[C]) {
            ...
            return a = $.extend(!0, {
                ...
                if (this.grid) {
                    var b = this, c = $.isFunction(a.beforeAddRow) ? a.beforeAddRow.call(b, a.addRowParams) : void 0;
    ...
    $.jgrid.extend({
        sortableColumns: function (a) {
            ...
            var d, e, f, g, h, i, j, k = this, l = {}, m = [], n = k.jqGrid("getGridParam", "colModel"),
                o = k.jqGrid("getGridParam", "colNames"), p = function (a) {
        ...
        pivotSetup: function (a, b) {
            ...
            return this.each(function () {
                ...
                function m(a, b, c, d) {
                    ...
                    for ($.isArray(c) ? (j = c.length, n = c) : (j = 1, n[0] = c), f = [], g = [], f.root = 0, i = 0; j > i; i++) {
                        var o, p = [];
                        for (e = 0; k > e; e++) {
                            if (null == c) h = $.trim(b[e].member) + "_" + b[e].aggregator, o = h, n[0] = b[e].label || b[e].aggregator + " " + $.trim(b[e].member); else {
                                o = c[i].replace(/\s+/g, "");
                                try {
                        ...
                        if ("object" != typeof a[e]) {
                            if ("level" === e) {
                                if (void 0 === J[a.level] && (J[a.level] = "", a.level > 0 && "_r_Totals" !== a.text && (i[a.level - 1] = {
                                    ...
                                    var h = i[a.level - 1].groupHeaders.length - 1, k = 0 === h ? L : K + t;
                ...
                if (j.rowTotals && j.yDimension.length > 0) {
                    ...
                    j.yDimension.splice(0, 0, {dataName: y}), j.yDimension[0].converter = function () {
                        return "_r_Totals"
                    }
                }
                ...
                var J = [], K = c.length, L = K;
                s > 0 && (i[s - 1] = {useColSpanStyle: !1, groupHeaders: []}), n(B);
                var M;
                if (j.colTotals) for (var N = d.length; N--;) for (q = r; q < c.length; q++) M = c[q].name, e[M] ? e[M] += parseFloat(d[N][M] || 0) : e[M] = parseFloat(d[N][M] || 0);
                if (A > 0) for (q = 0; A > q; q++) c[q].isGroupField && (h.groupingView.groupField.push(c[q].name), h.groupingView.groupSummary.push(j.groupSummary), h.groupingView.groupSummaryPos.push(j.groupSummaryPos)); else h.grouping = !1;
            ...
            return this.each(function () {
                function e(a) {
                    var d, e = jQuery(f).jqGrid("pivotSetup", a, b), g = $.assocArraySize(e.summary) > 0 ? !0 : !1,
                    ...
                    jQuery(f).jqGrid($.extend(!0, {
                        datastr: $.extend(h.select(), g ? {userdata: e.summary} : {}),
                        datatype: "jsonstring",
                        footerrow: g,
                        userDataOnFooter: g,
                        colModel: e.colModel,
                    ...
                    var d, e, f, g, h, i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base,
                        j = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common, k = function (a, b, d) {
                            ...
                            if ($(m).append(n), a && (h = c.p.jsonReader.subgrid, e = $.jgrid.getAccessor(a, h.root), void 0 !== e)) for (f = 0; f < e.length; f++) {
                                if (g = e[f], n = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), h.repeatitems === !0) for (h.cell && (g = g[h.cell]), l = 0; l < g.length; l++) k(n, g[l] || "&#160;", l); else {
        ...
        setTreeNode: function (a, b) {
            return this.each(function () {
                var c = this;
                if (c.grid && c.p.treeGrid) for (var d, e, f, g, h, i, j, k, l = c.p.expColInd, m = c.p.treeReader.expanded_field, n = c.p.treeReader.leaf_field, o = c.p.treeReader.level_field, p = c.p.treeReader.icon_field, q = c.p.treeReader.loaded, r = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common; b > a;) {
            ...
            return this.each(function () {
                ...
                if (e.p.treeGrid) {
                    e.p.treedatatype || $.extend(e.p, {treedatatype: e.p.datatype}), e.p.loadonce && (e.p.treedatatype = "local"), e.p.subGrid = !1, e.p.altRows = !1, e.p.pgbuttons = !1, e.p.pginput = !1, e.p.gridview = !0, null === e.p.rowTotal && (e.p.rowNum = 1e4), e.p.multiselect = !1, e.p.rowList = [], e.p.expColInd = 0, a = i.icon_plus, "jQueryUI" === e.p.styleUI && (a += "rtl" === e.p.direction ? "w" : "e"), e.p.treeIcons = $.extend({
                        plus: a,
                        minus: i.icon_minus,
                        leaf: i.icon_leaf
            ...
            return this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) switch (c.p.treeGridModel) {
                    case"nested":
                        ...
                        break;
                    case"adjacency":
                        for (var j = c.p.treeReader.parent_id_field, k = c.p.localReader.id, l = a[k], m = c.p._index[l]; m--;) if (c.p.data[m][k] === $.jgrid.stripPref(c.p.idPrefix, a[j])) {
                            b = c.p.data[m];
                            break
                        }
                }
            ...
            return this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) switch (c.p.treeGridModel) {
                    case"nested":
                        ...
                        break;
                    case"adjacency":
                        var j = c.p.treeReader.parent_id_field, k = c.p.localReader.id;
                        $(this.p.data).each(function () {
            ...
            var b = [];
            return this.each(function () {
                if (this.grid && this.p.treeGrid) for (var c = $(this).jqGrid("getNodeParent", a); c;) b.push(c), c = $(this).jqGrid("getNodeParent", c)
            }), b
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var b = this.p.localReader.id, c = this.p.selrow;
                    $(this).jqGrid("delChildren", a[b]);
                    var d = this.p.treeReader.expanded_field, e = this.p.treeReader.parent_id_field,
                        f = this.p.treeReader.loaded, g = this.p.treeReader.level_field,
                        h = this.p.treeReader.left_field, i = this.p.treeReader.right_field,
                        j = $.jgrid.getAccessor(a, this.p.localReader.id), k = $("#" + j, this.grid.bDiv)[0];
                    ...
                    }) : $(this).jqGrid("setGridParam", {selrow: c, postData: {nodeid: "", parentid: "", n_level: ""}})
                }
            })
        }, expandNode: function (a) {
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var b = this.p.treeReader.expanded_field, c = this.p.treeReader.parent_id_field,
                        d = this.p.treeReader.loaded, e = this.p.treeReader.level_field,
                        f = this.p.treeReader.left_field, g = this.p.treeReader.right_field;
                    if (!a[b]) {
                        var h = $.jgrid.getAccessor(a, this.p.localReader.id),
                            i = $("#" + this.p.idPrefix + $.jgrid.jqID(h), this.grid.bDiv)[0], j = this.p._index[h],
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid && e) for (c = this.p.localReader.id, b = 0; e > b; b++) f = $(this).jqGrid("getNodeAncestors", a[b]), f.length || f.push(a[b]), d = f[f.length - 1][c], -1 === $.inArray(d, g) && (g.push(d), f = $(this).jqGrid("getFullTreeNode", f[f.length - 1], !0), h = h.concat(f))
            }), h
            ...
            if (c) {
                ...
                if (void 0 === d && (d = !1), null == a) {
                    if (j = e.p.data.length - 1, j >= 0) for (; j >= 0;) u = Math.max(u, parseInt(e.p.data[j][e.p.localReader.id], 10)), j--;
                    a = u + 1
                }
    ...
    var J = $.jqDnR, M = J.dnr, E = J.e, E1, M1, i = function (a, b, c, d) {
        return a.each(function () {
            b = b ? $(b, a) : a, b.bind("mousedown", {e: a, k: c}, function (a) {
                var b = a.data, c = {};
        ...
        NumberFormat: function (a, b) {
            if ($.fmatter.isNumber(a) || (a *= 1), $.fmatter.isNumber(a)) {
                ...
                if ($.fmatter.isNumber(b.decimalPlaces)) {
                    var g = b.decimalPlaces, h = Math.pow(10, g);
